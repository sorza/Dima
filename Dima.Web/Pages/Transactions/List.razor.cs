...
namespace Dima.Web.Pages.Transactions
{
    public partial class ListTransactionsPage : ComponentBase
    {
        ...
        public string SearchTherm { get; set; } = string.Empty;
        ...
        public async void OnDeleteButtonClickedAsync(long id, string title)
        {
            var result = await DialogService.ShowMessageBox(
                title: "ATENÇÃO",
                message: $"Ao prosseguir, o lançamento {title} será excluído. Esta operação é irreversível. Deseja continuar?",
                yesText: "EXCLUIR",
                cancelText: "CANCELAR");
        ...
        public Func<Transaction, bool> Filter => transaction =>
        {
            ...
            return transaction.Id.ToString().Contains(SearchTherm, StringComparison.OrdinalIgnoreCase)
                || transaction.Title.ToString().Contains(SearchTherm, StringComparison.OrdinalIgnoreCase);
        };
